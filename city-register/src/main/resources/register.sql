...
INSERT INTO cr_person (sur_name, given_name, patronymic, date_of_birth,
 passport_series, passport_number, passport_issue_date, certificate_number, certificate_date)
VALUES ('Popov', 'Dmitry', 'Olegovich', '1995-03-18', '1234', '123456', '2015-04-11', null, null);

INSERT INTO cr_person (sur_name, given_name, patronymic, date_of_birth,
 passport_series, passport_number, passport_issue_date, certificate_number, certificate_date)
VALUES ('Popova', 'Polina', 'Igorevna', '1997-08-21', '4321', '6544321', '2017-09-19', null, null);

INSERT INTO cr_person (sur_name, given_name, patronymic, date_of_birth,
 passport_series, passport_number, passport_issue_date, certificate_number, certificate_date)
VALUES ('Popova', 'Yulia', 'Dmitryevna', '2016-01-11', null, null, null, '456123', '2016-01-20');

INSERT INTO cr_person (sur_name, given_name, patronymic, date_of_birth,
 passport_series, passport_number, passport_issue_date, certificate_number, certificate_date)
VALUES ('Popov', 'Yuri', 'Dmitryev', '2018-10-11', null, null, null, '321456', '2018-11-02');
...
--4. Паспорт - ФИО, дата рождения, Паспорт(серия/номер/дата выдачи),
